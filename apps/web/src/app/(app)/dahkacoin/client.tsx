    ...
    <div className="w-full max-w-[500px] space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-3 relative">
        ...
        <div className="hidden xl:block absolute right-full mr-4 top-0 w-36 text-[0.5rem] space-y-1.5 select-none">
          <p><span className="text-[var(--text)] opacity-20 hover:opacity-100 transition-opacity">accumulation</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">1-3min</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">·</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">calme</span></p>
          <p><span className="text-green-400 opacity-20 hover:opacity-100 transition-opacity">hausse</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">45s-1.5min</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">·</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">monte</span></p>
          <p><span className="text-green-500 opacity-20 hover:opacity-100 transition-opacity">euphorie</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">20-45s</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">·</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">vendre</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">vite</span></p>
          <p><span className="text-orange-400 opacity-20 hover:opacity-100 transition-opacity">distribution</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">1-2min</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">·</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">instable</span></p>
          <p><span className="text-red-400 opacity-20 hover:opacity-100 transition-opacity">baisse</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">1.5-2.5min</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">·</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">descente</span></p>
          <p><span className="text-red-500 opacity-20 hover:opacity-100 transition-opacity">capitulation</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">2-4min</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">·</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">opportunité</span></p>
          <p><span className="text-blue-400 opacity-20 hover:opacity-100 transition-opacity">récupération</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">1.5-3min</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">·</span> <span className="text-[var(--text-muted)] opacity-20 hover:opacity-100 transition-opacity">repart</span></p>
        </div>
